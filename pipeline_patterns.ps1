...
$logFile = "C:\Lavoro\Trading\intraday-market-screener\pipeline_patterns_log.txt"
...
Log "=== FASE 4: Pattern extraction 30 simboli Alpaca 5m (42000 barre) ==="
$ok = 0; $fail = 0
foreach ($sym in $syms) {
...
Log "=== COMPLETATO: OK=$ok FAIL=$fail ==="
